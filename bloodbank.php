...
<!DOCTYPE html>
	<html lang="en">
	  <head>
	   ...
	   <title>  <?php echo "bloodbank".'|'.$site_title; ?>  </title>
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Token Number</label>
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select name="state" class="form-control selectpicker" >
      <option value=" " >Please select your state</option>
      <?php $q="select * from donor_registration";
      				$r=mysqli_query($dbc, $q);
					while($option=mysqli_fetch_assoc($r)){ ?>
					      <option><?php echo $option['keystringkey'];?></option> 	
				<?php	}
       ?>
