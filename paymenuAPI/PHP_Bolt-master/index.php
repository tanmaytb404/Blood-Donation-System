...
<div class="main">
    ...
    <div>
    	<h3 style="color:red">*PLEASE ENTER ALL THE DETAILS CAREFULLY*</h3>
    </div>
	<form action="#" id="payment_form">
    <input type="hidden" id="udf5" name="udf5" value="BOLT_KIT_PHP7" />
    <input type="hidden" id="surl" name="surl" value="<?php echo getCallbackUrl(); ?>" />
    <div class="dv">
    <span><input type="hidden" id="key" name="key" placeholder="Merchant Key" value="TqX5hj5S" /></span>
    </div>
    
    <div class="dv">
    <span><input type="hidden" id="salt" name="salt" placeholder="Merchant Salt" value="3GKl1ydEs9" /></span>
    </div>
    ...
    <span><input type="text" id="pinfo" name="pinfo" placeholder="Product Info" value="" /></span>
    </div>
