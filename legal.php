...
<!DOCTYPE html>
	<html lang="en">
	  <head>
	   ...
	   <title>  <?php echo "LEGAL STATUS".'|'.$site_title; ?>  </title>
    ...
    <link href='https://fonts.googleapis.com/css?family=Aleo' rel='stylesheet'>
	   ...
	   <?php include('config/js.php') ?>
		...
		#intro{
			height: 250px;
			background: url('images/legal1.jpg');
...
<h1 style="font-family: 'Mangal'; color: white; text-align: center; font-size: 80px; font-style: bold; margin: 160px 0 0 0; opacity: 1">LEGAL STATUS</h1>
</div>
<div class="container">
 <div class="row">
 	  <div class="col-md-12">		       	 	
	<div id="details" style="margin:-20px 0 0 30px";>
			...
			<h2 style="font-family:'Stardos Stencil'; text-align: left">LEGAL STATUS</h2>
			<h4 style="font-family:  'Crimson Text', serif; letter-spacing: 1px; text-align: justify; font-weight: bold"><?php echo $ls['tca']; ?></h4>
		</div>
		</div>
		</div>
 	<!-- <div class="col"><a href="images/about img.jpg"><img src="images/about img.jpg"  width="500px" style="border: 2px solid black;"/></a></div> -->
...
Awarded in 2013 to return a Bihar Boy from OBUJ SABUJ</p>
	...
	<div class="row">
	<div class="col-md-6" style="border: 1px dotted gray">
		<h3 style="color: yellowgreen; font-size: x-large">Who We Are</h3>
		<img src="images/about img.jpg" width="200px" height="150px" style="border: 2px solid green"/>
		<div class="subcontent" style="margin-top: 10px">
				<p style=" letter-spacing:1px; text-align: justify; font-size: small">BIDHANNAGAR SOCIAL WELFARE SOCIETY is located in Siliguri, West Bengal. BIDHANNAGAR SOCIAL WELFARE SOCIETY is registered as a Society at Kolkata of State West Bengal with NGO unique Registration Id 'WB/2014/0073164'.
					</p>
			<a href="who.php" target="_blank" style="text-decoration: none">	<p style="font-family: 'Stardos Stencil'; font-style: italic;"><i class="fas fa-hand-point-right"></i> &nbsp; click here to know more</p>  </a>
				</div>
	</div>
	<!-- second col -->
	<div class="col-md-6" style="border: 1px dotted gray">
